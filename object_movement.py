...
lowerColor = np.array([color - sensitivity, 100, 100])
upperColor = np.array([color + sensitivity, 255, 255])
...
#inRange(hsv_image, new Scalar([I change this value]), new Scalar(60, 255, 255), ultimate_blue);
"""
